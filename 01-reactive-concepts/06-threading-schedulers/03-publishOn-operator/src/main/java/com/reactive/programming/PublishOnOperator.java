...
public class PublishOnOperator {
    ...
    private static final Logger log = LoggerFactory.getLogger(PublishOnOperator.class);
    ...
    public static void main(String[] args) {
        ...
        var flux = Flux.create(sink -> {
                ...
                .publishOn(Schedulers.boundedElastic())         // Switches the thread to boundedElastic for downstream
