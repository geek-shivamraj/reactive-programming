package com.reactive.project.advice;

import com.reactive.project.exceptions.CustomerNotFoundException;
import com.reactive.project.exceptions.InsufficientBalanceException;
import com.reactive.project.exceptions.InsufficientSharesException;
...
public class ApplicationExceptionHandler {
    ...
    public ProblemDetail handleException(InsufficientBalanceException ex) {
        return build(HttpStatus.BAD_REQUEST, ex, problem -> {
            problem.setType(URI.create("https://example.com/problems/insufficient-balance"));
