 ...
 *
 *      - Lifecycle Flow:
 *          - doFirst --> doOnSubscribe --> doOnRequest --> doOnComplete --> doOnTerminate --> doFinally
 */
public class DoCallbacksDemo1 {

    private static final Logger log = LoggerFactory.getLogger(DoCallbacksDemo1.class);
